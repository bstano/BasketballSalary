...
### Cross Validation between Feature Sets
...
### CV Results between Models and Feature Sets
...
# cv.tree(tree.share, k = nrow(bdata.share))
```
...
```{r}
bdata.share %>%
  select(-TWOP_P, -career_PTS, -career_TRB, -career_FG3_P, -career_eFG_P, -BLK) ->
bdata.share2
